...
bool __fastcall TTSSLoopTuner2MainForm::GetCanClose()
{
	...
	{
		int r = MessageDlg("�t�@�C�� " + FileName + ".sli �͕ύX����Ă��܂��B\n"
			"�ύX��ۑ����܂����H", mtWarning, TMsgDlgButtons() << mbYes << mbNo << mbCancel, 0);
		if(r == mrYes)
		{
			SaveAction->Execute();
		}
      ...
      TObject *Sender)
{
	...
	MessageDlg("Loop Tuner 2  version " + VersionString +
		...
		"�e�v���O�C���̃o�[�W�������� plugin �t�H���_�̒���"
		"�e DLL �̃v���p�e�B���Q�Ƃ��Ă�������",
...
void __fastcall TTSSLoopTuner2MainForm::OnReaderProgress(TObject *sender)
{
	...
	if(pct > 100) pct = 100;
	Caption = ExtractFileName(FileName) +  " - �ǂݍ��ݒ� " + AnsiString(pct) + "%";
	if(Reader->ReadDone)
	{
...
void __fastcall TTSSLoopTuner2MainForm::Open()
{
	...
	if(FileExists(FileName + ".sli"))
	{
		...
		try
		{
			...
			{
				throw Exception(FileName + ".sli �͕��@���Ԉ���Ă��邩�A"
					"�s���Ȍ`���̂��߁A�ǂݍ��ނ��Ƃ��ł��܂���");
			}
		}
		catch(...)
	  ...
	  bool &Done)
{
	...
	if(pos != -1)
	{
		...
		StatusBar->Panels->Items[3]->Text = "�Đ��� " + Reader->SamplePosToTimeString(pos);
