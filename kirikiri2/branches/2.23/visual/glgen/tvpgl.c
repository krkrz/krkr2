...
TVP_GL_FUNC_DECL(void, TVPAlphaBlend_a_c, (tjs_uint32 *dest, const tjs_uint32 *src, tjs_int len))
{
	tjs_uint32 d1, s, d, sopa, addr, destalpha;
	{
		...
		while(___index < len)
		{
	dest[(___index+0)] = TVPAdditiveBlend_a_d(dest[(___index+0)], src[(___index+0)]);
	dest[(___index+1)] = TVPAdditiveBlend_a_d(dest[(___index+1)], src[(___index+1)]);
	dest[(___index+2)] = TVPAdditiveBlend_a_d(dest[(___index+2)], src[(___index+2)]);
	dest[(___index+3)] = TVPAdditiveBlend_a_d(dest[(___index+3)], src[(___index+3)]);
			___index += 4;
		}
		...
		while(___index < len)
		{
	dest[___index] = TVPAdditiveBlend_a_d(dest[___index], src[___index]);
			___index ++;
		}
	}
}
...
{
	{
		...
		while(___index < len)
		{
	dest[(___index+0)] = TVPAdditiveBlend_a_d_o(dest[(___index+0)], src[(___index+0)], opa);
	dest[(___index+1)] = TVPAdditiveBlend_a_d_o(dest[(___index+1)], src[(___index+1)], opa);
	dest[(___index+2)] = TVPAdditiveBlend_a_d_o(dest[(___index+2)], src[(___index+2)], opa);
	dest[(___index+3)] = TVPAdditiveBlend_a_d_o(dest[(___index+3)], src[(___index+3)], opa);
			___index += 4;
		}
		...
		while(___index < len)
		{
	dest[___index] = TVPAdditiveBlend_a_d_o(dest[___index], src[___index], opa);
			___index ++;
		}
	}
}
...
{
	{
		...
		while(___index < len)
		{
	dest[(___index+0)] = TVPAdditiveBlend_n_a(dest[(___index+0)], src[(___index+0)]);
	dest[(___index+1)] = TVPAdditiveBlend_n_a(dest[(___index+1)], src[(___index+1)]);
	dest[(___index+2)] = TVPAdditiveBlend_n_a(dest[(___index+2)], src[(___index+2)]);
	dest[(___index+3)] = TVPAdditiveBlend_n_a(dest[(___index+3)], src[(___index+3)]);
			___index += 4;
		}
		...
		while(___index < len)
		{
	dest[___index] = TVPAdditiveBlend_n_a(dest[___index], src[___index]);
			___index ++;
		}
	}
}
...
{
	{
		...
		while(___index < len)
		{
	dest[(___index+0)] = TVPAdditiveBlend_HDA_n_a(dest[(___index+0)], src[(___index+0)]);
	dest[(___index+1)] = TVPAdditiveBlend_HDA_n_a(dest[(___index+1)], src[(___index+1)]);
	dest[(___index+2)] = TVPAdditiveBlend_HDA_n_a(dest[(___index+2)], src[(___index+2)]);
	dest[(___index+3)] = TVPAdditiveBlend_HDA_n_a(dest[(___index+3)], src[(___index+3)]);
			___index += 4;
		}
		...
		while(___index < len)
		{
	dest[___index] = TVPAdditiveBlend_HDA_n_a(dest[___index], src[___index]);
			___index ++;
		}
	}
}
...
{
	{
		...
		while(___index < len)
		{
	dest[(___index+0)] = TVPAdditiveBlend_HDA_n_a_o(dest[(___index+0)], src[(___index+0)], opa);
	dest[(___index+1)] = TVPAdditiveBlend_HDA_n_a_o(dest[(___index+1)], src[(___index+1)], opa);
	dest[(___index+2)] = TVPAdditiveBlend_HDA_n_a_o(dest[(___index+2)], src[(___index+2)], opa);
	dest[(___index+3)] = TVPAdditiveBlend_HDA_n_a_o(dest[(___index+3)], src[(___index+3)], opa);
			___index += 4;
		}
		...
		while(___index < len)
		{
	dest[___index] = TVPAdditiveBlend_HDA_n_a_o(dest[___index], src[___index], opa);
			___index ++;
		}
	}
}
...
{
	{
		...
		while(___index < len)
		{
	dest[(___index+0)] = TVPAdditiveBlend_a_a(dest[(___index+0)], src[(___index+0)]);
	dest[(___index+1)] = TVPAdditiveBlend_a_a(dest[(___index+1)], src[(___index+1)]);
	dest[(___index+2)] = TVPAdditiveBlend_a_a(dest[(___index+2)], src[(___index+2)]);
	dest[(___index+3)] = TVPAdditiveBlend_a_a(dest[(___index+3)], src[(___index+3)]);
			___index += 4;
		}
		...
		while(___index < len)
		{
	dest[___index] = TVPAdditiveBlend_a_a(dest[___index], src[___index]);
			___index ++;
		}
	}
}
...
{
	{
		...
		while(___index < len)
		{
	dest[(___index+0)] = TVPAdditiveBlend_a_a_o(dest[(___index+0)], src[(___index+0)], opa);
	dest[(___index+1)] = TVPAdditiveBlend_a_a_o(dest[(___index+1)], src[(___index+1)], opa);
	dest[(___index+2)] = TVPAdditiveBlend_a_a_o(dest[(___index+2)], src[(___index+2)], opa);
	dest[(___index+3)] = TVPAdditiveBlend_a_a_o(dest[(___index+3)], src[(___index+3)], opa);
			___index += 4;
		}
		...
		while(___index < len)
		{
	dest[___index] = TVPAdditiveBlend_a_a_o(dest[___index], src[___index], opa);
			___index ++;
		}
	}
}
...
TVP_GL_FUNC_DECL(void, TVPConstAlphaBlend_a_c, (tjs_uint32 *dest, const tjs_uint32 *src, tjs_int len, tjs_int opa))
{
	opa <<= 24;
	{
		...
		while(___index < len)
		{
	dest[(___index+0)] = TVPAdditiveBlend_a_a(dest[(___index+0)], (src[(___index+0)] & 0xffffff) | opa);
	dest[(___index+1)] = TVPAdditiveBlend_a_a(dest[(___index+1)], (src[(___index+1)] & 0xffffff) | opa);
	dest[(___index+2)] = TVPAdditiveBlend_a_a(dest[(___index+2)], (src[(___index+2)] & 0xffffff) | opa);
	dest[(___index+3)] = TVPAdditiveBlend_a_a(dest[(___index+3)], (src[(___index+3)] & 0xffffff) | opa);
			___index += 4;
		}
		...
		while(___index < len)
		{
	dest[___index] = TVPAdditiveBlend_a_a(dest[___index], (src[___index] & 0xffffff) | opa);
			___index ++;
		}
	}
}
...
TVP_GL_FUNC_DECL(void, TVPConstColorAlphaBlend_a_c, (tjs_uint32 *dest, tjs_int len, tjs_uint32 color, tjs_int opa))
{
	...
	tjs_uint32 opa_inv = ~opa;
	{
		...
		while(___index < len)
		{
	dest[(___index+0)] = TVPAdditiveBlend_a_ca(dest[(___index+0)], opa, opa_inv, src);
	dest[(___index+1)] = TVPAdditiveBlend_a_ca(dest[(___index+1)], opa, opa_inv, src);
	dest[(___index+2)] = TVPAdditiveBlend_a_ca(dest[(___index+2)], opa, opa_inv, src);
	dest[(___index+3)] = TVPAdditiveBlend_a_ca(dest[(___index+3)], opa, opa_inv, src);
			___index += 4;
		}
		...
		while(___index < len)
		{
	dest[___index] = TVPAdditiveBlend_a_ca(dest[___index], opa, opa_inv, src);
			___index ++;
		}
	}
}
...
TVP_GL_FUNC_PTR_DECL(void, TVPAdditiveAlphaBlend_d,  (tjs_uint32 *dest, const tjs_uint32 *src, tjs_int len));
TVP_GL_FUNC_PTR_DECL(void, TVPAdditiveAlphaBlend_a,  (tjs_uint32 *dest, const tjs_uint32 *src, tjs_int len));
TVP_GL_FUNC_PTR_DECL(void, TVPAdditiveAlphaBlend_do,  (tjs_uint32 *dest, const tjs_uint32 *src, tjs_int len, tjs_int opa));
TVP_GL_FUNC_PTR_DECL(void, TVPAdditiveAlphaBlend_ao,  (tjs_uint32 *dest, const tjs_uint32 *src, tjs_int len, tjs_int opa));
TVP_GL_FUNC_PTR_DECL(void, TVPConvertAdditiveAlphaToAlpha,  (const tjs_uint32 *buf, tjs_int len));
TVP_GL_FUNC_PTR_DECL(void, TVPConvertAlphaToAdditiveAlpha,  (const tjs_uint32 *buf, tjs_int len));
...
TVP_GL_FUNC_PTR_DECL(void, TVPStretchAdditiveAlphaBlend_d,  (tjs_uint32 *dest, tjs_int len, const tjs_uint32 *src, tjs_int srcstart, tjs_int srcstep));
...
TVP_GL_FUNC_PTR_DECL(void, TVPStretchAdditiveAlphaBlend_do,  (tjs_uint32 *dest, tjs_int len, const tjs_uint32 *src, tjs_int srcstart, tjs_int srcstep, tjs_int opa));
...
TVP_GL_FUNC_PTR_DECL(void, TVPLinTransAdditiveAlphaBlend_d,  (tjs_uint32 *dest, tjs_int len, const tjs_uint32 *src, tjs_int sx, tjs_int sy, tjs_int stepx, tjs_int stepy, tjs_int srcpitch));
...
TVP_GL_FUNC_PTR_DECL(void, TVPLinTransAdditiveAlphaBlend_do,  (tjs_uint32 *dest, tjs_int len, const tjs_uint32 *src, tjs_int sx, tjs_int sy, tjs_int stepx, tjs_int stepy, tjs_int srcpitch, tjs_int opa));
...
TVP_GL_FUNC_PTR_DECL(void, TVPRemoveAdditiveConstOpacity,  (tjs_uint32 *dest, tjs_int len, tjs_int strength));
TVP_GL_FUNC_PTR_DECL(void, TVPRemoveAdditiveOpacity,  (tjs_uint32 *dest, const tjs_uint8 *src, tjs_int len));
TVP_GL_FUNC_PTR_DECL(void, TVPRemoveAdditiveOpacity_o,  (tjs_uint32 *dest, const tjs_uint8 *src, tjs_int len, tjs_int strength));
TVP_GL_FUNC_PTR_DECL(void, TVPRemoveAdditiveOpacity65,  (tjs_uint32 *dest, const tjs_uint8 *src, tjs_int len));
TVP_GL_FUNC_PTR_DECL(void, TVPRemoveAdditiveOpacity65_o,  (tjs_uint32 *dest, const tjs_uint8 *src, tjs_int len, tjs_int strength));
...
TVP_GL_FUNC_DECL(void, TVPInitTVPGL, ())
{
	...
	TVPAdditiveAlphaBlend_d = TVPAdditiveAlphaBlend_d_c;
	TVPAdditiveAlphaBlend_a = TVPAdditiveAlphaBlend_a_c;
	TVPAdditiveAlphaBlend_do = TVPAdditiveAlphaBlend_do_c;
	...
	TVPStretchAdditiveAlphaBlend_d = TVPStretchAdditiveAlphaBlend_d_c;
	TVPStretchAdditiveAlphaBlend_a = TVPStretchAdditiveAlphaBlend_a_c;
	TVPStretchAdditiveAlphaBlend_do = TVPStretchAdditiveAlphaBlend_do_c;
	...
	TVPLinTransAdditiveAlphaBlend_d = TVPLinTransAdditiveAlphaBlend_d_c;
	TVPLinTransAdditiveAlphaBlend_a = TVPLinTransAdditiveAlphaBlend_a_c;
	TVPLinTransAdditiveAlphaBlend_do = TVPLinTransAdditiveAlphaBlend_do_c;
	...
	TVPRemoveAdditiveConstOpacity = TVPRemoveAdditiveConstOpacity_c;
	TVPRemoveAdditiveOpacity = TVPRemoveAdditiveOpacity_c;
	TVPRemoveAdditiveOpacity_o = TVPRemoveAdditiveOpacity_o_c;
	TVPRemoveAdditiveOpacity65 = TVPRemoveAdditiveOpacity65_c;
	TVPRemoveAdditiveOpacity65_o = TVPRemoveAdditiveOpacity65_o_c;
