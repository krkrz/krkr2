...
/* constants */\
 ...
 /* tTVPLayerType */ ltBinder=0, ltCoverRect=1, ltTransparent=2, ltAdditive=3, ltSubtractive=4, ltMultiplicative=5, ltEffect=6, ltFilter=7, ltDodge=8, ltDarken=9, ltLighten=10, ltScreen=11,\
 /* tTVPBlendOperationMode */ omAdditive=ltAdditive, omSubtractive=ltSubtractive, omMultiplicative=ltMultiplicative, omDodge=ltDodge, omDarken=ltDarken, omLighten=ltLighten, omScreen=ltScreen,\
 /* tTVPDrawFace */ dfBoth=0, dfMain=1  ,dfMask=2,dfProvince=3,\
