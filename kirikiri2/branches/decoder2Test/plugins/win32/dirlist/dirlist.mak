...
VERSION = BCB.05.03
# ---------------------------------------------------------------------------
PROJECT = "D:\Program Files\Borland\CBuilder5\Projects\tvp2win32\environ\win32\plugin\dirlist.dll"
OBJFILES = intermediate\Main.obj intermediate\tp_stub.obj
RESFILES = 
MAINSOURCE = dirlist.bpf
RESDEPEN = $(RESFILES)
LIBFILES = 
IDLFILES = 
IDLGENFILES = 
...
INCLUDEPATH = $(BCB)\include;$(BCB)\include\vcl;..\..\..\base\win32\plugin_kit
LIBPATH = ..\..\..\base\win32\plugin_kit;$(BCB)\lib\obj;$(BCB)\lib
WARNINGS= -w-par
# ---------------------------------------------------------------------------
CFLAG1 = -WD -Od -H=$(BCB)\lib\vcl50.csm -Hc -Vx -Ve -X- -r- -a8 -b- -k -y -v -vi- \
    -tWD -tWM -c
IDLCFLAGS = 
PFLAGS = -N2intermediate -N0intermediate -$YD -$W -$O- -v -JPHNE -M
RFLAGS = 
AFLAGS = /mx /w2 /zd
LFLAGS = -Iintermediate -D"" -aa -Tpd -x -Gn -Gi -v
# ---------------------------------------------------------------------------
