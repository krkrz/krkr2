...
public:
	...
	/**
	 * ÉvÉçÉpÉeÉBÇìoò^
	 * @param key ìoò^ÉvÉçÉpÉeÉBñº
	 * @param set ìoò^ëŒè€ÇÃsetterå^ÇÃä÷êî
	 * @param get ìoò^ëŒè€ÇÃgetterå^ÇÃä÷êî
	 * Å¶setter/getterÇ«ÇøÇÁÇ©Ç™ñ≥Ç¢èÍçáÇÕ 0 ÇéwíËÇµÇ‹Ç∑
	 */
	template <typename SET, typename GET>
	...
	/**
	 * íËêîÇìoò^
	 * @param key ìoò^íËêîñº
	 * @param value ìoò^ëŒè€ÇÃíl(tTJSVariantÇÃÉRÉìÉXÉgÉâÉNÉ^Ç…ìnÇπÇÈå^)
	 * Å¶valueÇï‘Ç∑getterÇÃÇ›ÇÃÉvÉçÉpÉeÉBÇìoò^ÇµÇ‹Ç∑
	 */
	template <typename T>
	 ...
	 * @param key ìoò^ñº
	 * @param value ìoò^ëŒè€ÇÃíl(tTJSVariantÇÃÉRÉìÉXÉgÉâÉNÉ^Ç…ìnÇπÇÈå^)
	 * @param flag PropSetÇ…ìnÇ∑ÉtÉâÉOíl
	 */
	template <typename T>
	...
	/**
	 * ÉNÉâÉXÇÇìoò^
	 * @param key ìoò^ÉNÉâÉXñº
	 * @param ctor ìoò^ëŒè€ÇÃfactoryå^ÇÃä÷êî
	 */
	template <typename CTOR>
	 ...
	 * @param key ìoò^ÉNÉâÉXñº
	 * @param ctor ìoò^ëŒè€ÇÃfactoryå^ÇÃä÷êî
	 * @param dtor ìoò^ëŒè€ÇÃÉfÉXÉgÉâÉNÉ^
	 */
	template <typename CTOR, typename DTOR>
	...
	/**
	 * ÉGÉâÅ[É`ÉFÉbÉN
	 * ç°Ç‹Ç≈ÇÃìoò^Å^âèúìÆçÏÇ≈ÉGÉâÅ[Ç™Ç»Ç©Ç¡ÇΩÇ©Ç«Ç§Ç©ämîF
	 * @return valid ÉGÉâÅ[Ç™ñ≥Ç¢èÍçáÇÕtrue
	 */
	bool IsValid() const { return !_error; }


	/**
	 * iTJSDispatch2Ç©ÇÁîCà”ÇÃÉNÉâÉXÉCÉìÉXÉ^ÉìÉXÇÃïœä∑
	 * @param obj ïœä∑ëŒè€ÉIÉuÉWÉFÉNÉg
	 * @param instance ïœä∑ÇµÇΩÇ¢ÉNÉâÉXÇÃå^É|ÉCÉìÉ^ÅiÉ^ÉOópÉ_É~Å[Åj
	 * @return É|ÉCÉìÉ^
	 */
	template <class C>
