...
#else // [XXX] for utf8hack
#define UTF8HACK_REPLACEMACRO
...
#endif // [XXX] remove for utf8hack
//---------------------------------------------------------------------------
iTJSTextReadStream * TVPCreateTextStreamForRead(const ttstr & name,
	const ttstr & modestr)
{
	return new tTVPTextReadStream(name, modestr, DefaultReadCodePage);
}
#if 0 // [XXX] remove for utf8hack
//---------------------------------------------------------------------------
