...
// �ȉ��̓��define��OpenType �t�H���g��\���Ă��āA
// EnumFontsProc �� lpntme->ntmTm.ntmFlags �Ƀr�b�g�Z�b�g�Ƃ��ēn����Ă���B
// (OpenType���T�|�[�g���ꂽ Windows 2000 �ȍ~�ő���)
// tBaseFreeTypeFontDriver::EnumerateFonts �ł�TrueType �t�H���g�ƂƂ���
// �����̃t�H���g���񋓂����B

#ifndef NTM_PS_OPENTYPE
#define NTM_PS_OPENTYPE     0x00020000 //!< PostScript �`�� OpenType �t�H���g
#endif

#ifndef NTM_TT_OPENTYPE
#define NTM_TT_OPENTYPE     0x00040000 //!< TrueType �`�� OpenType �t�H���g
#endif
