...
static void TVPCheckMIDIDelay()
{
	...
	int delay = TVPMIDIDelayTick - timeGetTime();
...
static void TVPSetMIDIDelay(int ms)
{
	...
	TVPMIDIDelayTick = timeGetTime() + ms;
}
//---------------------------------------------------------------------------
...
class tTVPSMFTrack
{
	...
	tjs_uint8 *Position; // current position
...
//---------------------------------------------------------------------------
void __fastcall tTJSNI_MIDISoundBuffer::WndProc(Messages::TMessage &Msg)
{
